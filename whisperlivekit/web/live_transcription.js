...
const translationIcon = `<svg class="translation_icon" xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#5f6368"><path d="m603-202-34 97q-4 11-14 18t-22 7q-20 0-32.5-16.5T496-133l152-402q5-11 15-18t22-7h30q12 0 22 7t15 18l152 403q8 19-4 35.5T868-80q-13 0-22.5-7T831-106l-34-96H603ZM362-401 188-228q-11 11-27.5 11.5T132-228q-11-11-11-28t11-28l174-174q-35-35-63.5-80T190-640h84q20 39 40 68t48 58q33-33 68.5-92.5T484-720H80q-17 0-28.5-11.5T40-760q0-17 11.5-28.5T80-800h240v-40q0-17 11.5-28.5T360-880q17 0 28.5 11.5T400-840v40h240q17 0 28.5 11.5T680-760q0 17-11.5 28.5T640-720h-76q-21 72-63 148t-83 116l96 98-30 82-122-125Zm266 129h144l-72-204-72 204Z"/></svg>`
...
const languageIcon = `<svg class="language_icon" xmlns="http://www.w3.org/2000/svg" height="12" viewBox="0 -960 960 960" width="12" fill="#5f6368"><path d="M480-80q-82 0-155-31.5t-127.5-86Q143-252 111.5-325T80-480q0-83 31.5-155.5t86-127Q252-817 325-848.5T480-880q83 0 155.5 31.5t127 86q54.5 54.5 86 127T880-480q0 82-31.5 155t-86 127.5q-54.5 54.5-127 86T480-80Zm0-82q26-36 45-75t31-83H404q12 44 31 83t45 75Zm-104-16q-18-33-31.5-68.5T322-320H204q29 50 72.5 87t99.5 55Zm208 0q56-18 99.5-55t72.5-87H638q-9 38-22.5 73.5T584-178ZM170-400h136q-3-20-4.5-39.5T300-480q0-21 1.5-40.5T306-560H170q-5 20-7.5 39.5T160-480q0 21 2.5 40.5T170-400Zm216 0h188q3-20 4.5-39.5T580-480q0-21-1.5-40.5T574-560H386q-3 20-4.5 39.5T380-480q0 21 1.5 40.5T386-400Zm268 0h136q5-20 7.5-39.5T800-480q0-21-2.5-40.5T790-560H654q3 20 4.5 39.5T660-480q0 21-1.5 40.5T654-400Zm-16-240h118q-29-50-72.5-87T584-782q18 33 31.5 68.5T638-640Zm-234 0h152q-12-44-31-83t-45-75q-26 36-45 75t-31 83Zm-200 0h118q9-38 22.5-73.5T376-782q-56 18-99.5 55T204-640Z"/></svg>`
...
function setupWebSocket() {
  return new Promise((resolve, reject) => {
    ...
    websocket.onmessage = (event) => {
      ...
      // lastReceivedData.lines.reverse();
...
function renderLinesWithBuffer(
  ...
  //     "<p style='text-align: center; color: var(--muted); margin-top: 20px;'><em>Continue speaking...</em></p>";
  //   return;
  // }
  ...
  console.log(JSON.stringify(reversedLines), 'tp[', buffer_transcription, '] d', buffer_diarization, 'tl[', buffer_translation, current_status, ']');
  is_buffer_transcription_appended = false;

  const linesHtml = (reversedLines)
    .map((item, idx) => {
      // if (!!item.text && !!item.translation && buffer_transcription) {
      //   return;
      // }
      let timeInfo = "";
      ...
      if (item.text.length > 0 || buffer_transcription) {
        currentLineText += `
                  <div class="label_translation">
                        ${languageIcon}
                        <span class="original_text">${item.text}
              `;

        if (!is_buffer_transcription_appended && buffer_transcription) {
          if (isFinalizing) {
            currentLineText +=
          ...
          is_buffer_transcription_appended = true;
        }

        currentLineText += '</span>'

        let translationContent = "";
        if (item.translation) {
          translationContent += item.translation.trim();
        }
        if (idx === 0 && buffer_translation) {
